...
function [F1, F2all, F3all, Fstruc] = getFconv(w1, L1, del, Rgrid, dRval)
...
if ~((1-w1) == L22/(L22 + L1) && w23 == L23/(L23 + L1 + L33) &&...
        w33 == L33/(L23 + L1 + L33))
...
% Test plot
figure;
plot(del, F1, 'k', 'LineWidth', 2);
hold on;
plot(del, F2all, 'b', 'LineWidth', 2);
plot(del, F3all, 'r', 'LineWidth', 2);