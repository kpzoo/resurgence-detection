...
function [Rhoriz, Ihoriz, Rstats, Istats] = predHoriz(Rgrid, nPts, eta, horiz, qR, Lam, Iday, pR0, distvals, nday)
...
Ihoriz = quantile(Isamp', [0.025, 0.5, 0.975])';
